        ...
        <>
            ...
            <section id="home">
                <div className="container-fluid col-md-10">
                    <div className="row">
                        <div className="col-md-7 order-md-2" data-aos="fade-right" data-aos-duration="800" data-aos-delay="400" data-aos-easing="slide">
                            <img src={page} alt="Company Image"/>
                        </div>
                        <div className="col-md-5 order-md-1" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400" data-aos-easing="slide">
