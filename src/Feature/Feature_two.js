                    ...
                    <div className="row justify-content-center align-items-center" style={{ height: '100vh' }}>
                        <div className="col-md-7">
                            <div className="card">
                                <div className="card-body">
                                    <img src={dashboard_1} alt="Dashboard Image" style={{ height: 600, width: 600 }} />
                                </div>
                            </div>
                        </div>
                        <div className="col-md-5">
                            <div className="card">
                                <div className="card-body">
                                    <div className="row p-4">
                                        <div className="col-2 text-bg-info text-light fa-2x rounded-4" style={{ height: 60, width: 60 }}>
                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="row p-4">
                                        <div className="col-2 text-bg-warning text-light fa-2x rounded-4" style={{ height: 60, width: 60 }}>
                                        ...
                                        <div className="col-10">
                                            <h3 className="text-dark">Build Products</h3>
                                            <p className="text-secondary">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="card" >
                                <div className="card-body">
                                    <div className="row p-4">
                                        <div className="col-2 text-bg-danger text-light fa-2x rounded-4" style={{ height: 60, width: 60 }}>
                                        ...
                                        <div className="col-10">
                                            <h3 className="text-dark">Success Every Day</h3>
                                            <p className="text-secondary">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="card" >
                                <div className="card-body">
                                    <div className="row p-4">
                                        <div className="col-2 text-bg-primary text-light fa-2x rounded-4" style={{ height: 60, width: 60 }}>
                                        ...
                                        <div className="col-10">
                                            <h3 className="text-dark">Bring Ideas To Life</h3>
                                            <p className="text-secondary">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                                        </div>
                                    </div>
                                </div>
