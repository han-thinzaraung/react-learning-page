                    ...
                    <div className="">
                        <div className="container">
                            <div className="row  vh-100 justify-content-between align-items-center">
                                {/* item cards */}
                                <div className="col-lg-5 order-lg-last mt-3">
                                    <div className="row card_hover" data-bs-target="#demo" data-bs-slide="next">
                                        <div className="col-2 text-bg-info text-light rounded-4 d-flex align-items-center" style={{ height: 40, width: 40 }}>
                                    ...
                                    <div className="row card_hover" data-bs-target="#demo" data-bs-slide="next">
                                        ...
                                        <div className="col-2 text-bg-warning text-light rounded-4 d-flex align-items-center" style={{ height: 40, width: 40 }}>
                                    ...
                                    <div className="row card_hover" data-bs-target="#demo" data-bs-slide="next">
                                        ...
                                        <div className="col-2 text-bg-danger text-light  rounded-4 d-flex align-items-center" style={{ height: 40, width: 40 }}>
                                    ...
                                    <div className="row card_hover" data-bs-target="#demo" data-bs-slide="next">
                                        ...
                                        <div className="col-2 text-bg-primary text-light rounded-4 d-flex align-items-center" style={{ height: 40, width: 40 }}>
