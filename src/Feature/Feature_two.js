        ...
        <>
            ...
            <section id="feature_two" className="bg-light">
                <div className="container">
                    <div className="row">
                        <div className="col-md-4 px-5 order-md-2">
                            <div className="card border-0 bg-light card_size" data-aos="fade-left" data-aos-duration="800" data-aos-delay="100" data-aos-easing="slide">
                                <div className="card-body card_hover" data-bs-target="#demo" data-bs-slide="next">
                                    <div className="row">
                                        ...
                                        <div className="col-md-10">
                                            <h5 className="text-dark card_text" data-aos="fade-left">Grow Your Business</h5>
                                            <p className="text-secondary">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="card border-0 bg-light card_size"data-aos="fade-left" data-aos-duration="800" data-aos-delay="200" data-aos-easing="slide">
                                <div className="card-body card_hover" data-bs-target="#demo" data-bs-slide="next">
                                    <div className="row">
                            ...
                            <div className="card border-0 px-2 bg-light card_size" data-aos="fade-left" data-aos-duration="800" data-aos-delay="300" data-aos-easing="slide">
                                <div className="card-body card_hover" data-bs-target="#demo" data-bs-slide="next">
                                    <div className="row">
                            ...
                            <div className="card  border-0 px-2 bg-light card_size" data-aos="fade-left" data-aos-duration="800" data-aos-delay="400" data-aos-easing="slide">
                                <div className="card-body card_hover" data-bs-target="#demo" data-bs-slide="next">
                                    <div className="row">
                            ...
                            <div id="demo" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div className="card card-body  shadow border-0" data-aos="fade-left" data-aos-duration="800" data-aos-delay="400" data-aos-easing="slide">
                                            <img src={dashboard_1} alt="dashboard"/>
                                        </div>
                                    </div>
