...
export default function Feature_three() {
    return (
        <>
            {/* Feature Three */}
            <section id="feature_three">
                <div class="container-fluid col-10">
                    <div class="row">
                        <div className="col-lg-3 col-sm-10 mb-4 d-flex justify-content-center">
                            <div className="card  p-3" style={{ width: '16rem' }}>
                                <div className="col-2 text-bg-info text-light fa-2x rounded-4 text-center" style={{ height: 60, width: 60 }}>
                                ...
                                <div className="card-body">
                                    <h4 className="card-title">Grow Your Business</h4>
                        ...
                        <div className="col-lg-3 col-sm-10 mb-4 d-flex justify-content-center">
                            <div className="card p-3" style={{ width: '16rem' }}>
                                <div className="col-2 text-bg-warning text-light fa-2x rounded-4 text-center" style={{ height: 60, width: 60 }}>
                                ...
                                <div className="card-body">
                                    <h4 className="card-title">Build Products</h4>
                                    <p className="card-text">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 col-sm-10 mb-4 d-flex justify-content-center">
                            <div className="card p-3" style={{ width: '16rem' }}>
                                <div className="col-2 text-bg-danger text-light text-center fa-2x rounded-4" style={{ height: 60, width: 60 }}>
                                ...
                                <div className="card-body">
                                    <h4 className="card-title">Success Every Day</h4>
                                    <p className="card-text">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 col-sm-10 mb-4 d-flex justify-content-center">
                            <div className="card p-3" style={{ width: '16rem' }}>
                                <div className="col-2 text-bg-primary text-light fa-2x rounded-4 text-center" style={{ height: 60, width: 60 }}>
                                ...
                                <div className="card-body">
                                    <h4 className="card-title">Bring Ideas To Life</h4>
                                    <p className="card-text">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                                </div>
                            </div>
                        </div>
